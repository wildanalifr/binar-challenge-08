...
import TableCustom from './Components/PlayerTable'
          ...
          <Col xs={6}>
            ...
            <Form>
              <Form.Group as={Row} className="mb-3" controlId="formHorizontalUsername">
                ...
                <Col sm={10}>
                  <Form.Control type="text" value={formAddPlayer.username} name="username" onChange={changeHandler} placeholder="Username" />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3" controlId="formHorizontalEmail">
                ...
                <Col sm={10}>
                  <Form.Control type="email" value={formAddPlayer.email} name="email" onChange={changeHandler} placeholder="Email" />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3" controlId="formHorizontalExp">
                ...
                <Col sm={10}>
                  <Form.Control type="number" value={formAddPlayer.exp} name="exp" onChange={changeHandler} placeholder="Experience" />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3" controlId="formHorizontalLvl">
                ...
                <Col sm={10}>
                  <Form.Control type="number" value={formAddPlayer.lvl} name="lvl" onChange={changeHandler} placeholder="Level" />
                </Col>
              </Form.Group>
          ...
          <Col xs={6}>
            ...
            <Form>
              ...
              <Form.Group as={Row} className="mb-3" controlId="formHorizontalUsername">
                ...
                <Col sm={10}>
                  <Form.Control type="text" value={formEditPlayer.username} name="username" onChange={editHandler} placeholder="Username" />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3" controlId="formHorizontalEmail">
                ...
                <Col sm={10}>
                  <Form.Control type="email" value={formEditPlayer.email} name="email" onChange={editHandler} placeholder="Email" />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3" controlId="formHorizontalExp">
                ...
                <Col sm={10}>
                  <Form.Control type="number" value={formEditPlayer.exp} name="exp" onChange={editHandler} placeholder="Experience" />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3" controlId="formHorizontalLvl">
                ...
                <Col sm={10}>
                  <Form.Control type="number" value={formEditPlayer.lvl} name="lvl" onChange={editHandler} placeholder="Level" />
                </Col>
              </Form.Group>
